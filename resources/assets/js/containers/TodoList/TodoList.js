...
class TodoList extends Component{
  ...
  addTaskHandler(event){
    ...
    let params = {title: this.state.task.title, done: 0}
  ...
  render(){
    ...
    return(
      ...
      <div className="wrapper">
        ...
        <AddTaskForm changed={this.taskTitleChangedHandler} submitted={this.addTaskHandler} title={this.state.task.title} />
        
        <TaskList tasks={this.state.tasks} marker={this.taskUpdateHandler} delete={this.deleteTaskHandler} />
